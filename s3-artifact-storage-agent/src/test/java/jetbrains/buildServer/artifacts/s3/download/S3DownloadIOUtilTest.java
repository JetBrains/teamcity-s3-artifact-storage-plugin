...
public class S3DownloadIOUtilTest {
  ...
  public Object[][] transferExpectedAndAllBytesTestData() {
    return new Object[][]{
      {100_000}, // more data than buffer size
      {10_000}, // data size equals buffer size
      {1_000}, // fewer data than bufer size
      {50_000_000}, // signifacantly more data (~50 MB)
      {0}, // empty channel
    };
  }
  ...
  public Object[][] transferExpectedFileBytesTestData() {
    return new Object[][]{
      ...
      },
      {
        10_000,
        0,
        12_123, // target position beyond data size
      },
      {
        50_000_000, // ~50 MB data
        345,
        12_123,
      },
      {
