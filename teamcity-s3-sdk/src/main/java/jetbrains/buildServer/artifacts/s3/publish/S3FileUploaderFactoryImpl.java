...
import jetbrains.buildServer.artifacts.s3.publish.presigned.upload.S3PresignedUploadFactory;
...
public class S3FileUploaderFactoryImpl implements S3FileUploaderFactory {
  ...
  public S3FileUploader create(@NotNull final S3Configuration s3Configuration,
    ...
    return s3Configuration.isUsePresignedUrls()
           ? new S3SignedUrlFileUploader(s3Configuration, s3UploadLogger, presignedUrlsProviderClientSupplier, new S3PresignedUploadFactory())
