...
public class OldS3PreSignUrlHelper {
  ...
  @NotNull
  static Map<String, URL> readPreSignUrlMapping(@NotNull final String data) {
    try {
  ...
  @NotNull
  static String writePreSignUrlMapping(@NotNull Map<String, URL> data) {
  ...
  @NotNull
  static Collection<String> readS3ObjectKeys(@NotNull final String data) {
    try {
      final Element rootElement = XmlUtil.from_s(data);
  ...
  @NotNull
  static String writeS3ObjectKeys(@NotNull final Collection<String> s3ObjectKeys) {
